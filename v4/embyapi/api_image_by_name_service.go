...
/*
ImageByNameServiceApiService Gets all general images by name
...
/*
ImageByNameServiceApiService Gets a general image by name
...
/*
ImageByNameServiceApiService Gets all media info image by name
Requires authentication as user
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
ImageByNameServiceApiService Gets a media info image by name
No authentication required
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param name The name of the image
...
func (a *ImageByNameServiceApiService) GetImagesMediainfoByThemeByName(ctx context.Context, name string, theme string) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"Name"+"}", fmt.Sprintf("%v", name), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"Theme"+"}", fmt.Sprintf("%v", theme), -1)
...
/*
ImageByNameServiceApiService Gets all rating images by name
Requires authentication as user
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
ImageByNameServiceApiService Gets a rating image by name
No authentication required
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param name The name of the image
  - @param theme The theme to get the image from
