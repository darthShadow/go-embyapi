...
/*
NotificationsServiceApiService Gets notifications
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
 * @param optional nil or *NotificationsServiceApiGetNotificationsByUseridOpts - Optional Parameters:
     * @param "IsRead" (optional.Bool) -  An optional filter by IsRead
...
func (a *NotificationsServiceApiService) GetNotificationsByUserid(ctx context.Context, userId string, localVarOptionals *NotificationsServiceApiGetNotificationsByUseridOpts) (EmbyNotificationsApiNotificationResult, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.IsRead.IsSet() {
		localVarQueryParams.Add("IsRead", parameterToString(localVarOptionals.IsRead.Value(), ""))
	}
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v EmbyNotificationsApiNotificationResult
...
/*
NotificationsServiceApiService Gets a notification summary for a user
Requires authentication as user
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param userId User Id
...
func (a *NotificationsServiceApiService) GetNotificationsByUseridSummary(ctx context.Context, userId string) (EmbyNotificationsApiNotificationsSummary, *http.Response, error) {
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v EmbyNotificationsApiNotificationsSummary
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *NotificationsServiceApiService) GetNotificationsTypes(ctx context.Context) ([]NotificationsNotificationTypeInfo, *http.Response, error) {
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []NotificationsNotificationTypeInfo
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param optional nil or *NotificationsServiceApiPostNotificationsAdminOpts - Optional Parameters:
     ...
     * @param "Level" (optional.Interface of NotificationsNotificationLevel) -  The notification level
...
/*
NotificationsServiceApiService Marks notifications as read
Requires authentication as user
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param userId User Id
...
/*
NotificationsServiceApiService Marks notifications as unread
Requires authentication as user
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param userId User Id
  - @param ids A list of notification ids, comma delimited
